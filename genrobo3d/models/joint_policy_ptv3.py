...
class SimplePolicyPTV3AdaNorm(BaseModel):
    ...
    def forward(self, batch, compute_loss=False, **kwargs):
        ...
        if compute_loss:
            ...
            return final_pred_actions, final_pred_joints_actions, pc_token, pc_coord, losses
        else:
            return final_pred_actions, final_pred_joints_actions, pc_token, pc_coord

    def compute_loss(self, pred_actions, tgt_actions, pred_joint, tgt_joint, disc_pos_probs=None, npoints_in_batch=None):
        """
        Args:
        ...
        return {
            'pos': pos_loss, 'rot': rot_loss, 'open': open_loss, 'joint': joint_loss,
            'total': total_loss
        }
