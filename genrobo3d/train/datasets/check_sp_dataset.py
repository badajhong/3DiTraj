...
if __name__ == '__main__':
    ...
    # Go two levels up to reach the root of the project
    project_root = os.path.abspath(os.path.join(script_dir, '..', '..', '..'))


    dataset = SimplePolicyDataset(
        data_dir=os.path.join(project_root, 'data/gembench/train_dataset/keysteps_bbox_pcd/seed0/voxel1cm'),
        instr_embed_file=os.path.join(project_root, 'data/gembench/train_dataset/keysteps_bbox_pcd/instr_embeds_clip.npy'),
        taskvar_instr_file=os.path.join(project_root, 'assets/taskvars_instructions_new.json'),
        taskvar_file=os.path.join(project_root, 'assets/taskvars_train.json'), 
    ...
    sample_data = dataset[399]

    # Inspect keys and tensor shapes
