...
from genrobo3d.models.stage2_ptv3_posrot import SimplePolicyPTV3AdaNorm, SimplePolicyPTV3CA  # or AdaNorm
...
def main(config):
    ...
    for epoch_id in range(restart_epoch, config.TRAIN.num_epochs):
        ...
        for step, batch in enumerate(trn_dataloader):
            final_pred_actions, pc_tokens, _ = ptv3_model(batch, compute_loss=False, global_step=None)
...
if __name__ == '__main__':
    ...
    exp_config_path = "genrobo3d/configs/rlbench/stage2_dit_posrot.yaml"
    opts = [
    ]
    # ===============================================
