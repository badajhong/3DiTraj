...
cd $HOME/Desktop/3DiTraj

# Add current directory to PYTHONPATH
export PYTHONPATH=$HOME/Desktop/3DiTraj:$PYTHONPATH
...
python genrobo3d/train/train_dit_policy.py \
    --exp-config genrobo3d/configs/rlbench/dit_policy_ptv3.yaml \
